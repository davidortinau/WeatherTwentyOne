...
namespace WeatherTwentyOne.MacCatalyst
{
    public class TrayService : NSObject, ITrayService
    {
        ...
        public void Initialize()
        {
            ...
            statusBarImage = Runtime.GetNSObject(IntPtr_objc_msgSend(Class.GetHandle("NSImage"), Selector.GetHandle("alloc")));
            ...
            // Handle click
            void_objc_msgSend_IntPtr(statusBarButton.Handle, Selector.GetHandle("setTarget:"), Handle);
