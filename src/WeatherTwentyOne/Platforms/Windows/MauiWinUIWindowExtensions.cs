...
namespace WeatherTwentyOne
{
    ...
    {
        public static IntPtr GetNativeWindowHandle(this Microsoft.UI.Xaml.Window window)
        {
            var nativeWindow = window.As<IWindowNative>();
            return nativeWindow.WindowHandle;
        }

        public static void SetIcon(this Microsoft.UI.Xaml.Window window, string iconFilename)
        {
        ...
        public static void BringToFront(this Microsoft.UI.Xaml.Window window)
        {
            var hwnd = window.GetNativeWindowHandle();
        ...
        public static void MinimizeToTray(this Microsoft.UI.Xaml.Window window)
        {
            var hwnd = window.GetNativeWindowHandle();
